...
public/          Static files baked into nginx at build time (HTML, CSS, JS, images)
  ...
  70s2.html      Redesigned 70s player — self-contained (inline CSS+JS), "Soul FM" / Maximalist Soul Poster aesthetic
  80s2.html      Redesigned 80s player — self-contained (inline CSS+JS), "Power 80s" / Brutalist Neon Grid aesthetic
  90s2.html      Redesigned 90s player — self-contained (inline CSS+JS), "Altitude 99" / Editorial Swiss-Grid aesthetic
...
scripts/         One-off utility scripts
  gen_pages.py   Regenerates 70s2/80s2/90s2/artist2 HTML files from source JS; run with `python3 scripts/gen_pages.py`
...
| Redesigned decade players (v2) | ✅ Done | `public/70s2.html`, `80s2.html`, `90s2.html` — single self-contained files, distinctive era aesthetics, all original functionality preserved; regenerate via `python3 scripts/gen_pages.py` |
